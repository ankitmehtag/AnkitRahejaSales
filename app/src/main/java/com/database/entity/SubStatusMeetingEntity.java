...
@Entity(tableName = "tbl_sub_status_meeting")
@TypeConverters({UpdateStatusConverter.class})
public class SubStatusMeetingEntity {
    ...
    public SubStatusMeetingEntity(String enquiryId, String userId, String projects, String projectsId,
                                  String assignTo, String assignToId, String oldStatus, String oldStatusId, String newStatus,
                                  String newStatusId,String updateStatusId, String updateStatusList, String subStatus, String subStatusId,
                                  String address, String date, String time, String leadType, String remark, String lastupdatedon) {
