...
@Entity(tableName = "tbl_sub_status_site_visit")
@TypeConverters({UpdateStatusConverter.class})
public class SubStatusSiteVisitEntity {
    ...
    public SubStatusSiteVisitEntity(String enquiryId, String userId,  String projects, String projectsId,
                                    ...
                                    String updateStatusList, String subStatus, String subStatusId, int noOfPerson,
