...
public abstract class BaseFragment extends Fragment {
	 ...
	 * fragment to getInstance the rootview for it.
	 * 
...
//		if(this instanceof VenueListFragment){
//			((HomeActivity)getActivity()).showMapIcon=true;
//			getActivity().invalidateOptionsMenu();
//		}else{
//			((HomeActivity)getActivity()).showMapIcon=false;
//			getActivity().invalidateOptionsMenu();
//		}
		getActivity().invalidateOptionsMenu();
	}
