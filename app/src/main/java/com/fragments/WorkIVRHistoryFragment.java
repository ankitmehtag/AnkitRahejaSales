...
public class WorkIVRHistoryFragment extends Fragment {

    public static final String TAG = WorkHistoryFragment.class.getSimpleName();
    ...
    private void parseJson(JSONObject jsonObject) throws JSONException {
        ...
        JSONArray workArray = mJsonObject.optJSONArray("work_history");
        if (workArray != null)
