...
import com.fragments.WorkIVRHistoryFragment;
import com.fragments.WorkIVRNoteFragment;
...
public class IVRHistory extends AppCompatActivity implements TabLayout.OnTabSelectedListener,
        AsmHistoryAdapter.OnBackPressListener, View.OnClickListener, MediaPlayer.OnCompletionListener {

    private static final String TAG = IVRHistory.class.getSimpleName();
    private IVRHistory.SectionsPagerAdapter mSectionsPagerAdapter;
    ...
    private void getAsmHistory(final String mobile) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, WEBAPI.getWEBAPI(APIType.IVR_HISTORY),
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (!response.equalsIgnoreCase("null")) {
                            ...
                            tabLayout.getTabAt(0).setText(IVRHistory.this.getResources().getString(R.string.tab_work_history));
                            tabLayout.getTabAt(1).setText(IVRHistory.this.getResources().getString(R.string.tab_history_notes));
                            ...
                            tabLayout.setTabTextColors(
                                    ContextCompat.getColor(IVRHistory.this, R.color.black_alpha_40),
                                    ContextCompat.getColor(IVRHistory.this, R.color.black)
                            );
                            // tabLayout.setupWithViewPager(mViewPager);
                            tabLayout.addOnTabSelectedListener(IVRHistory.this);
                            mViewPager.addOnPageChangeListener(new TabLayout.TabLayoutOnPageChangeListener(tabLayout));
                        } else {
                            Toast.makeText(IVRHistory.this, "Some thing went wrong!", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(ParamsConstants.MOBILE_NO, mobile);
    ...
    public void onCompletion(MediaPlayer mp) {
        try {
            ...
            imgPlay.setImageDrawable(ContextCompat.getDrawable(IVRHistory.this, R.drawable.ic_play_circle));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return new WorkIVRHistoryFragment();
                case 1:
                    return new WorkIVRNoteFragment();
                default:
                    return null;
            }
        }
    ...
    private void createPlayerDialog(Context context, String audioFilePath) {
        ...
        if (!extension.equalsIgnoreCase(BMHConstants.CALL_REC_EXTENSION_MP3)) {
            Utils.showToast(IVRHistory.this, getString(R.string.file_extension_not_correct));
            return;
        }
