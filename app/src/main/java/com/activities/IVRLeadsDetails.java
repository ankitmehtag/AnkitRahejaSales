...
public class IVRLeadsDetails extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, AdapterView.OnItemSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ivrleaddetail);
        app = (BMHApplication) getApplication();
        Toolbar toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("Mobile no");
        ...
        customer=(TextView)findViewById(R.id.tv_customer_name);
      ...
      //  self.setChecked(true);
        ...
        if (tag.equalsIgnoreCase(MyFirebaseMessagingService.TAG)) {
            camapign = intent.getStringExtra("campaign_title");
            ...
            camapign = mData.getcampaign_title();
            mobile = mData.getmobile_no();
...
*/        }
       ...
       /* Intent i =getIntent();
    String s1=i.getStringExtra("campaign");*/
   ...
   // customer.setText(s1);
    ...
    private void getCorporateActivityData() {
        ...
        if (Integer.valueOf(ca_min_budget) >= Integer.valueOf(ca_max_budget)) {
            Toast.makeText(IVRLeadsDetails.this, getString(R.string.toast_msg_min_budget_could_not_greater), Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, WEBAPI.getWEBAPI(APIType.ADD_LEADS),
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.optBoolean("success")) {
                                Utils.showToast(IVRLeadsDetails.this, jsonObject.optString("message"));
                                ...
                                Utils.showToast(IVRLeadsDetails.this, getString(R.string.something_went_wrong));
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (!Connectivity.isConnected(IVRLeadsDetails.this)) {
                            app.saveIntoPrefs(BMHConstants.IS_BACK_FROM_UPDATE, true);
                            app.saveTabIntoPrefs(getString(R.string.key_navigation), getString(R.string.tab_follow_up));
                            onBackPressed();
                        }
            ...
            protected Map<String, String> getParams() {
                ...
                new InsertAddAppointmentTask(IVRLeadsDetails.this, appointEntity).execute();
                return params;
            }
    ...
    private void setUiData() {
        ...
        spCaLeadStatusList.add(6, getString(R.string.text_marketing_calls));*/
        ...
        minAdapter = new ArrayAdapter(IVRLeadsDetails.this, R.layout.textview_spinner, budgetMin);
        ...
        maxAdapter = new ArrayAdapter(IVRLeadsDetails.this, R.layout.textview_spinner, budgetMax);
        ...
        personAdapter = new ArrayAdapter(IVRLeadsDetails.this, R.layout.textview_spinner, personArray);
               ...
               /* ca_max_budget = parent.getItemAtPosition(position).toString();
                ...
                if (objCaMax.equals(getString(R.string.txt_max_budget)))
                    ...
                    if (Integer.valueOf(ca_min_budget) < Integer.valueOf(ca_max_budget)) {
                        ...
                        Toast.makeText(IVRLeadsDetails.this, getString(R.string.toast_msg_max_budget_could_not_less), Toast.LENGTH_SHORT).show();
                    }
                }
                break;
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.tv_meeting_date_val:
                ...
                fromDateDialog = new DatePickerDialog(IVRLeadsDetails.this, dateChangeListener, mYear, mMonth, mDay);
                fromDateDialog.getDatePicker().setMinDate(System.currentTimeMillis() - 1000);
                fromDateDialog.show();
                break;
            case R.id.tv_meeting_time_val:
                if (TextUtils.isEmpty(tv_meeting_date_val.getText().toString())) {
                    Toast.makeText(IVRLeadsDetails.this, getString(R.string.select_date_first), Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                mTimePicker = new TimePickerDialog(IVRLeadsDetails.this, onTimeSetListener, mHour,
            ...
            case R.id.tv_date_val_self:
                ...
                fromDateDialog = new DatePickerDialog(IVRLeadsDetails.this, dateSelfChangeListener, mYear, mMonth, mDay);
                fromDateDialog.getDatePicker().setMinDate(System.currentTimeMillis() - 1000);
                fromDateDialog.show();
                break;
            case R.id.tv_date_val_ca:
                ...
                fromDateDialog = new DatePickerDialog(IVRLeadsDetails.this, dateCorporateActivityChangeListener, mYear, mMonth, mDay);
                fromDateDialog.getDatePicker().setMinDate(System.currentTimeMillis() - 1000);
                fromDateDialog.show();
                break;
            case R.id.tv_time_val_ca:
                ...
                mTimePicker = new TimePickerDialog(IVRLeadsDetails.this, onCorporateActivityTimeSetListener, mHour,
                        mMinute, false);//Yes 24 hour time
                mTimePicker.setTitle("Select Time");
                mTimePicker.show();
                break;
            case R.id.tv_time_val_self:
                ...
                mTimePicker = new TimePickerDialog(IVRLeadsDetails.this, onSelfTimeSetListener, mHour,
                        mMinute, false);//Yes 24 hour time
                mTimePicker.setTitle("Select Time");
                mTimePicker.show();
                break;
    ...
    private void setSelectedDate(int year, int month, int dayOfMonth, TextView textview) {
        ...
        if (selectedCal.getTimeInMillis() >= currentCal.getTimeInMillis()) {
            ...
            Toast.makeText(IVRLeadsDetails.this, getString(R.string.date_picker_error), Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void setSelectedTime(int hourOfDay, int minute, TextView textView) {
        ...
        if (selectedCal.getTimeInMillis() > currentCal.getTimeInMillis()) {
            ...
            Toast.makeText(IVRLeadsDetails.this, getString(R.string.invalid_time_picker_error), Toast.LENGTH_SHORT).show();
        }
    }
