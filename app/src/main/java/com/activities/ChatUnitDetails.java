...
import com.sp.CommentListActivity;
import com.sp.ConnectivityReceiver;
import com.sp.CustomAsyncTask;
import com.sp.DownloadService;
import com.sp.FullScreenMapActivity;
...
public class ChatUnitDetails extends BaseFragmentActivity implements GalleryCallback, ConnectivityReceiver.ConnectivityReceiverListener {

    private static final String TAG = ChatUnitDetails.class.getSimpleName();
    ...
    private TextView tvAddress, tvRsPerSqFt, tvSize, tvPricePsf,
            tvPLCRate, tvPLCPTotal, tvUnitNumber, tvUnitNo_title, UBilderName, Ufloor, UtvRoomDetails, readdeveloper, payment_plan,
            tvBuilderDescription;
    private Activity ctx = this;
    private String id, title, total_types, flat_typology, unitType, priceSqft, paymentPlan;
    private UnitDetailVO unitDetailVO;
    private TextView tvRating;
    private final int LOGIN_REQ_CODE = 451;
    // public HashMap<String, String> searchParams;
    TextView tvTimer;
    private Button btn_Prevoius, btn_Next, btn_Prevoius1, btn_Next1, btn_Prevoius2, btn_Next2,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_unit_details);
        ...
        paymentPlan = getIntent().getStringExtra("payment_plan");
        ...
        if (ConnectivityReceiver.isConnected()) {
            ...
            mNetworkErrorObject = Utils.showNetworkErrorDialog(ChatUnitDetails.this, UIEventType.RETRY_UNIT_DETAILS,
                    new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (ConnectivityReceiver.isConnected()) {
                                ...
                                Utils.showToast(ChatUnitDetails.this, getString(R.string.check_your_internet_connection));
                            }
                        }
                    });
        }
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rat == 0f) {
                    app.showToastAtCenter(ctx, "Please select rating");
                } else {
                    if (userid != "") {
    ...
    private void setViewsAndData() {
        ...
        payment_plan = (TextView) findViewById(R.id.payment_plan);
        ...
        tvUnitPrice.setText(unitDetailVO.getBsp());
        if (!TextUtils.isEmpty(paymentPlan)) {
            if (paymentPlan.equalsIgnoreCase("Down Payment Plan")) {
                paymentPlanUrl = unitDetailVO.getDown_payment_plan();
            } else if (paymentPlan.equalsIgnoreCase("possession linked plan")) {
                paymentPlanUrl = unitDetailVO.getPossession_plan();
            } else if (paymentPlan.equalsIgnoreCase("Construction Linked Plan")) {
                paymentPlanUrl = unitDetailVO.getConstruction_plan();
            }
        }
        WebView paymentPlanWebView = (WebView) findViewById(R.id.webviewPaymentPlan);
        paymentPlanWebView.loadData(paymentPlanUrl + impStyle, "text/html", "UTF-8");
        if (paymentPlan == null) {
            payment_plan.setText("No Payment Available");
            paymentPlanWebView.setVisibility(View.GONE);
        } else {
            payment_plan.setText(paymentPlan);
        }
        ...
        buttonEnquire.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showEnquryDialog();
            }
        ...
        specification_view.setOnClickListener(new View.OnClickListener() {
        ...
        tv_Insights.setOnClickListener(new View.OnClickListener() {
        ...
        tv_builder.setOnClickListener(new View.OnClickListener() {
        ...
        btn_Prevoius1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        btn_Prevoius2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        btn_Prevoius3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        btn_Prevoius6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        readdeveloper.setOnClickListener(new View.OnClickListener() {
            // boolean temp = false;
...
//		}
        ...
        if (titleMap.size() == 0) {
            ...
            LinearLayout.LayoutParams overViewParams = new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.MATCH_PARENT);
...
//			llComments.setVisibility(View.GONE);
            ...
            if (fm != null) {
                fm.getMapAsync(new OnMapReadyCallback() {
                    ...
                    public void onMapReady(GoogleMap googleMap) {
                        ...
                        if (ActivityCompat.checkSelfPermission(ChatUnitDetails.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED &&
                                ActivityCompat.checkSelfPermission(ChatUnitDetails.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(ChatUnitDetails.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, BMHConstants.ACCESS_FINE_LOCATION);
                            return;
                        }
                        setMapAndZoom(map);
                    }
    ...
    View.OnClickListener placesOnclick = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    private boolean checkPermissions() {
        hasExtCallPermission = ContextCompat.checkSelfPermission(ChatUnitDetails.this, Manifest.permission.CALL_PHONE);
    ...
    private void actionCall() {
        String uri = "tel:" + unitDetailVO.getBuilder_contactno().trim();
