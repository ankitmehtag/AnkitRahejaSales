...
import static com.helper.BMHConstants.USER_EMAIL;

public class S1 extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, AdapterView.OnItemSelectedListener,
    ...
    LinearLayout name_divider,email_divider,project_divider,alternate_mobileno_divider,budget_divider,status_divider,meeting_date_divider,meeting_time_divider,no_person_divider,meeting_address_divider;
...
LinearLayout Custom,email,project,alternate,budg,status,date,time,noofperson,mettingaddress,leadtype,re;
    private ArrayList<LeadStatus> mLeadStatusList=new ArrayList<>();
    ...
    String isLead;
    TextView campaign,lead;
    private IvrLeadModel mData;
    ...
    private String brokerId, brokerName, projectName, projectId, lead_status, ca_lead_status, ca_lead_status_id, lead_status_id, brokerAddress,
            ...
            builderId = "", userId = "",customeremail="";
    ...
    String appointmentType, campaigne,customerName, emailId, mobileNo, selectedProject, selectedProjectId, alternateMobileNo,budget, currentLeadStatus, currentLeadStatusId,
            leadStatusDateAndTime, address, remark, currentLeadType, no_of_persons, activity_id, activity_name;

    //Self Views
    EditText tv_customer_name_val, tv_email_id_val, tv_alternate_mobile_no_val;
...
TextView  tv_mobile_no_val;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lead =findViewById(R.id.test);
        projectListType = new TypeToken<ArrayList<Projects>>() {
        }.getType();
     Intent resultIntent=getIntent();
        String s1 = resultIntent.getStringExtra("campaign_title");
        campaign.setText(s1);
        String s2 = resultIntent.getStringExtra("mobile_no");
        tv_mobile_no_val.setText(s2);
        isLead = resultIntent.getStringExtra("IsLead");
        lead.setText(isLead);


        String master_project_list=resultIntent.getStringExtra("master_project_list");
       // Intent intent = getIntent();
       /* String tag = intent.getStringExtra("tag");
        if (tag.equalsIgnoreCase(MyFirebaseMessagingService.TAG)) {
            campaign = intent.getStringExtra("campaign_title");
            tv_mobile_no_val = intent.getStringExtra("mobile_no");
            isLead = "1";

        } else if (tag.equalsIgnoreCase(IVRLeads.TAG)) {
            mData = intent.getParcelableExtra("BROKERS_MODEL");
            campaign = mData.getcampaign_title();
            tv_mobile_no_val = mData.getmobile_no();
            isLead = mData.getIsLead();
        }*/


        app = (BMHApplication) getApplication();
        Toolbar toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("IVR Details");
...
Custom=findViewById(R.id.custom);
        project=findViewById(R.id.layout_tv_project_name);
        email=findViewById(R.id.linear_layout_email);
        alternate=findViewById(R.id.linear_layout_alternate_mobile);
        budg=findViewById(R.id.bud);
        status=findViewById(R.id.status);
        date=findViewById(R.id.layout_date_self);
        time=findViewById(R.id.layout_time_self);
        noofperson=findViewById(R.id.layout_no_of_persons_self);
        mettingaddress=findViewById(R.id.layout_address_self);
        leadtype=findViewById(R.id.layout_lead_type_self);
        re=findViewById(R.id.re);

        name_divider=findViewById(R.id.name_divider);
        email_divider=findViewById(R.id.tv_email_id_divider);
        project_divider=findViewById(R.id.project_divider);
        alternate_mobileno_divider=findViewById(R.id.tv_alternate_mobile_no_divider);
        budget_divider=findViewById(R.id.budget_divider);
        status_divider=findViewById(R.id.status_divider);
        meeting_date_divider=findViewById(R.id.layout_last_updated_on_divider_self);
        meeting_time_divider=findViewById(R.id.layout_time_divider_self);
        meeting_address_divider=findViewById(R.id.layout_address_divider_self);
        no_person_divider=findViewById(R.id.layout_no_of_persons_self_divider);
        ...
        if( isLead.equals("1")){
            ...
            budg.setVisibility(View.GONE);
            date.setVisibility(View.GONE);
            time.setVisibility(View.GONE);
            noofperson.setVisibility(View.GONE);
            mettingaddress.setVisibility(View.GONE);
            leadtype.setVisibility(View.GONE);
            re.setVisibility(View.VISIBLE);
            name_divider.setVisibility(View.GONE);
            email_divider.setVisibility(View.GONE);
            project_divider.setVisibility(View.GONE);
            alternate_mobileno_divider.setVisibility(View.GONE);
            budget_divider.setVisibility(View.GONE);
            status_divider.setVisibility(View.GONE);
            meeting_date_divider.setVisibility(View.GONE);
            meeting_time_divider.setVisibility(View.GONE);
            meeting_address_divider.setVisibility(View.GONE);
            no_person_divider.setVisibility(View.GONE);


            Toast.makeText(getApplicationContext(),"value is one ",Toast.LENGTH_SHORT).show();
        }
else

    {
        ...
        budg.setVisibility(View.VISIBLE);
        date.setVisibility(View.VISIBLE);
        time.setVisibility(View.VISIBLE);
        noofperson.setVisibility(View.VISIBLE);
        mettingaddress.setVisibility(View.VISIBLE);
        leadtype.setVisibility(View.VISIBLE);
        re.setVisibility(View.VISIBLE);
        name_divider.setVisibility(View.VISIBLE);
        email_divider.setVisibility(View.VISIBLE);
        project_divider.setVisibility(View.VISIBLE);
        alternate_mobileno_divider.setVisibility(View.VISIBLE);
        budget_divider.setVisibility(View.VISIBLE);
        status_divider.setVisibility(View.VISIBLE);
        meeting_date_divider.setVisibility(View.VISIBLE);
        meeting_time_divider.setVisibility(View.VISIBLE);
        meeting_address_divider.setVisibility(View.VISIBLE);
        no_person_divider.setVisibility(View.VISIBLE);
        ...
        mLeadStatusList.add(new LeadStatus("1","test"));
        mLeadStatusList.add(new LeadStatus("1","test"));
        mLeadStatusList.add(new LeadStatus("1","test"));
        corporateActivityList = intent.getParcelableArrayListExtra("corporate_list");

       // projectsMasterList = Gson.fromJson(master_project_list.toString(), master_project_list);
        projectsMasterList =new Gson().fromJson(master_project_list, projectListType);
    ...
    private void getCorporateActivityData() {
        ...
        if (Integer.valueOf(ca_min_budget) >= Integer.valueOf(ca_max_budget)) {
            Toast.makeText(S1.this, getString(R.string.toast_msg_min_budget_could_not_greater), Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void getSelfLeadData() {
        ...
        if(isLead.equals("0"))   // show all the fields

        {
            appointmentType = "self";
            campaigne = campaign.getText().toString();

            if (TextUtils.isEmpty(campaigne)) {
            ...
            if (currentLeadStatus.equals(getString(R.string.text_marketing_calls))) {
                ...
                if (TextUtils.isEmpty(remark)) {
                   ...
                   else if(currentLeadStatus.equals(getString(R.string.text_just_enquiry))) {
                currentLeadType = leadType;
                if (TextUtils.isEmpty(currentLeadType)) {
                    Utils.showToast(this, "Choose Lead Type");
                    return;
                ...
                if (TextUtils.isEmpty(remark)) {
                   ...
                   else if(currentLeadStatus.equals(getString(R.string.text_not_interested))) {
                currentLeadType = leadType;
                if (TextUtils.isEmpty(currentLeadType)) {
                    Utils.showToast(this, "Choose Lead Type");
                    return;
    ...
    private void addAppointment(final AppointmentModel updateData) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, WEBAPI.getWEBAPI(APIType.SAVE_LEADS),
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.optBoolean("success")) {
                                Utils.showToast(S1.this, jsonObject.optString("message"));
                                ...
                                Utils.showToast(S1.this, getString(R.string.something_went_wrong));
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (!Connectivity.isConnected(S1.this)) {
                            app.saveIntoPrefs(BMHConstants.IS_BACK_FROM_UPDATE, true);
                            app.saveTabIntoPrefs(getString(R.string.key_navigation), getString(R.string.tab_follow_up));
                            onBackPressed();
                        }
            ...
            protected Map<String, String> getParams() {
                ...
                //params.put("type", updateData.getType());
                 params.put("campaign",updateData.getCampaign());
             ...
             //   params.put("activity_name", updateData.getActivity_name());
                ...
                new InsertAddAppointmentTask(S1.this, appointEntity).execute();
                return params;
            }
    ...
    private void addBrokerMeeting() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, WEBAPI.getWEBAPI(APIType.BROKER_MEETING),
            ...
            protected Map<String, String> getParams() {
                Map<String, String> params = new HashMap<>();
                params.put(ParamsConstants.EMAIL_ID, BMHConstants.USER_EMAIL);
    ...
    private void setUiData() {
        customeremail=BMHConstants.USER_EMAIL;
        ...
        spLeadStatusList.add(5, getString(R.string.text_just_enquiry));
        spLeadStatusList.add(6, getString(R.string.text_not_interested));
        ...
        minAdapter = new ArrayAdapter(S1.this, R.layout.textview_spinner, budgetMin);
        ...
        maxAdapter = new ArrayAdapter(S1.this, R.layout.textview_spinner, budgetMax);
        ...
        personAdapter = new ArrayAdapter(S1.this, R.layout.textview_spinner, personArray);
        ...
        spProjectList.add(1, getString(R.string.OMA));
        spProjectList.add(2, getString(R.string.REVANTA));
        spProjectList.add(3, getString(R.string.ATHARVA));
        spProjectList.add(4, getString(R.string.SHILAS));
        spProjectList.add(5, getString(R.string.VEDAANTA));
        spProjectList.add(6, getString(R.string.THEVEDAS));
        spProjectList.add(7, getString(R.string.VEDAANTAFLOORS));
        spProjectList.add(8, getString(R.string.NAVODAYA));
        spProjectList.add(9, getString(R.string.SAMPADA));
        spProjectList.add(10, getString(R.string.TRINITY));
        spProjectList.add(11, getString(R.string.HIGHWAYARCADE));
        spProjectList.add(12, getString(R.string.KRISHNACOMMERICAL));
        spProjectList.add(13, getString(R.string.ARANYA));
        spProjectList.add(14, getString(R.string.KRISHNAHOUSHING));
        spProjectList.add(15, getString(R.string.MAHESHWARA));
        spProjectList.add(16, getString(R.string.VANYA));
        spProjectList.add(17, getString(R.string.AKSHARADEENDAYALJANAWASYOJANA));
               ...
               /* ca_max_budget = parent.getItemAtPosition(position).toString();
                ...
                if (objCaMax.equals(getString(R.string.txt_max_budget)))
                    ...
                    if (Integer.valueOf(ca_min_budget) < Integer.valueOf(ca_max_budget)) {
                        ...
                        Toast.makeText(S1.this, getString(R.string.toast_msg_max_budget_could_not_less), Toast.LENGTH_SHORT).show();
                    }
                }
                break;
    ...
    private void setDynamicViews(String leadType) {
        if (linearLayoutSelf.getVisibility() == View.VISIBLE) {
            ...
            else if (leadType.equalsIgnoreCase(getString(R.string.text_marketing_calls))) {
                layout_select_lead.setVisibility(View.VISIBLE);
                /*layout_address.setVisibility(View.VISIBLE);
                layout_lead_type_divider.setVisibility(View.VISIBLE);*/
                date.setVisibility(View.GONE);
            ...
            else if (leadType.equalsIgnoreCase(getString(R.string.text_just_enquiry))) {
                layout_select_lead.setVisibility(View.VISIBLE);
                /*layout_address.setVisibility(View.VISIBLE);
                layout_lead_type_divider.setVisibility(View.VISIBLE);*/
                date.setVisibility(View.GONE);
            ...
            else if (leadType.equalsIgnoreCase(getString(R.string.text_not_interested))) {
                layout_select_lead.setVisibility(View.VISIBLE);
                /*layout_address.setVisibility(View.VISIBLE);
                layout_lead_type_divider.setVisibility(View.VISIBLE);*/
                date.setVisibility(View.GONE);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.tv_meeting_date_val:
                ...
                fromDateDialog = new DatePickerDialog(S1.this, dateChangeListener, mYear, mMonth, mDay);
                fromDateDialog.getDatePicker().setMinDate(System.currentTimeMillis() - 1000);
                fromDateDialog.show();
                break;
            case R.id.tv_meeting_time_val:
                if (TextUtils.isEmpty(tv_meeting_date_val.getText().toString())) {
                    Toast.makeText(S1.this, getString(R.string.select_date_first), Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                mTimePicker = new TimePickerDialog(S1.this, onTimeSetListener, mHour,
            ...
            case R.id.tv_date_val_self:
                ...
                fromDateDialog = new DatePickerDialog(S1.this, dateSelfChangeListener, mYear, mMonth, mDay);
                fromDateDialog.getDatePicker().setMinDate(System.currentTimeMillis() - 1000);
                fromDateDialog.show();
                break;
            case R.id.tv_date_val_ca:
                ...
                fromDateDialog = new DatePickerDialog(S1.this, dateCorporateActivityChangeListener, mYear, mMonth, mDay);
                fromDateDialog.getDatePicker().setMinDate(System.currentTimeMillis() - 1000);
                fromDateDialog.show();
                break;
            case R.id.tv_time_val_ca:
                ...
                mTimePicker = new TimePickerDialog(S1.this, onCorporateActivityTimeSetListener, mHour,
                        mMinute, false);//Yes 24 hour time
                mTimePicker.setTitle("Select Time");
                mTimePicker.show();
                break;
            case R.id.tv_time_val_self:
                ...
                mTimePicker = new TimePickerDialog(S1.this, onSelfTimeSetListener, mHour,
                        mMinute, false);//Yes 24 hour time
                mTimePicker.setTitle("Select Time");
                mTimePicker.show();
                break;
    ...
    private void setSelectedDate(int year, int month, int dayOfMonth, TextView textview) {
        ...
        if (selectedCal.getTimeInMillis() >= currentCal.getTimeInMillis()) {
            ...
            Toast.makeText(S1.this, getString(R.string.date_picker_error), Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void setSelectedTime(int hourOfDay, int minute, TextView textView) {
        ...
        if (selectedCal.getTimeInMillis() > currentCal.getTimeInMillis()) {
            ...
            Toast.makeText(S1.this, getString(R.string.invalid_time_picker_error), Toast.LENGTH_SHORT).show();
        }
    }
