...
public class ProjectSearchAdapter extends BaseAdapter {
    ...
    private  final String TAG = ProjectSearchAdapter.class.getName();
    private Context mContext = null;
    private Typeface gothambook,icomoonfree = null;
    public ArrayList<ProjectsData> dataList;
    public ArrayList<ProjectsData> filterList = new ArrayList<>();

    public ProjectSearchAdapter(Context mContext, ArrayList<ProjectsData> dataList) {
    ...
    public void performFiltering(CharSequence constraint) {
        ...
        if(filterList != null){
            if (constraint.length() == 0) {
                ...
                for (final ProjectsData data : filterList) {
   ...
   /* public class CustomFilter extends Filter {
       // private ProjectSearchAdapter mAdapter;
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            dataList = (ArrayList<ProjectsData>) results.values;
            notifyDataSetChanged();
        }
    }
*/
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(dataList != null && dataList.size() > position) {
            holder.tv_project.setText(dataList.get(position).getProject_name());
