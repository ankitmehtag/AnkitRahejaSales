...
public class TypefaceUtil {
	 ...
	 * SET TYPEFACE FOR APP THEME AS DEFAULT_CALLS TYPEFACE WHICH WILL BE OVERRIDDEN
	 * 
	 * @param context
	 *            to work with assets
	...
	public static void overrideFont(Context context, String defaultFontNameToOverride,
		...
		try {
			...
			Log.e(TAG + customFontFileNameInAssets, " instead of " + defaultFontNameToOverride);
		}
	}
