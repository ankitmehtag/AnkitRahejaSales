...
public interface SdkUIConstants {
    ...
    String KEY = BMHConstants.IS_STAGING ? "gtKFFx":"P4FmEs";
    String SALT = "eCwWELxi";
    String S_URL = "https://payu.herokuapp.com/success";
    String F_URL = "https://payu.herokuapp.com/failure";
    String C_URL = F_URL;

    String PAYMENT_MODE = "mobile";
